...
export function AppShell({ activePage, version, settings, onNavigate, onThemeToggle, children }: AppShellProps) {
  return (
    <div className="dark h-screen overflow-hidden bg-background text-primary">
      <div className="flex h-screen overflow-hidden">
        <Sidebar activePage={activePage} onNavigate={onNavigate} version={version} settings={settings} onThemeToggle={onThemeToggle} />
